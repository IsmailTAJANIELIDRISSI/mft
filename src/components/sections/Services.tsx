...
import { Settings, PenTool, Wrench, RefreshCw, FileText, Package } from 'lucide-react';
        ...
        >
          {servicesSet.map((service, index) => (
            ...
            >
              ...
              <h3 className="font-heading font-bold text-xl text-mft-dark mb-4">{service.title}</h3>
              <p className="text-mft-grey text-sm mb-8 leading-relaxed flex-grow">
                {service.desc}
              </p>
              
              <div className="mt-auto">
                <a href="#contact" className="inline-flex items-center gap-2 text-sm font-bold text-mft-orange group/link">
                  En savoir plus 
