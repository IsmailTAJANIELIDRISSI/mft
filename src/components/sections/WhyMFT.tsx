...
const WhyMFT = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-mft-orange via-[#E36612] to-[#B84E0B] relative overflow-hidden">
      {/* Background patterns */}
      <div className="absolute top-0 right-0 w-1/2 h-full opacity-10" style={{ backgroundImage: 'radial-gradient(white 1px, transparent 1px)', backgroundSize: '20px 20px' }}></div>
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="mb-12">
          <span className="text-white/80 uppercase tracking-widest text-xs font-bold mb-2 inline-block">WHY CHOOSE MFT</span>
          <h2 className="font-heading font-extrabold text-3xl lg:text-4xl text-white">Pourquoi nous choisir ?</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reasons.map((reason, i) => (
            ...
            >
              ...
              <h3 className="font-heading font-bold text-2xl text-white mb-2">{reason.title}</h3>
