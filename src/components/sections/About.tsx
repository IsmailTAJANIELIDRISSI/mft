        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="font-heading font-bold text-4xl lg:text-5xl tracking-tight text-mft-dark mb-6 leading-tight">
              Maghreb Fueling <br/><span className="text-mft-orange">Technologies</span>
            </h2>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 items-start p-4 rounded-xl bg-mft-bg border border-gray-100 hover:border-mft-orange/30 hover:shadow-lg hover:shadow-mft-orange/5 transition-all">
                ...
                <div>
                  <h4 className="font-heading font-bold text-lg text-mft-dark mb-1">Expertise Technique</h4>
                  <p className="text-sm text-mft-grey">Équipes certifiées et expérimentées pour garantir la fiabilité de vos installations.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start p-4 rounded-xl bg-mft-bg border border-gray-100 hover:border-mft-green/30 hover:shadow-lg hover:shadow-mft-green/5 transition-all">
                ...
                <div>
                  <h4 className="font-heading font-bold text-lg text-mft-dark mb-1">Engagement Environnemental</h4>
                  <p className="text-sm text-mft-grey">Solutions conformes aux normes environnementales les plus strictes.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start p-4 rounded-xl bg-mft-bg border border-gray-100 hover:border-mft-orange/30 hover:shadow-lg hover:shadow-mft-orange/5 transition-all">
                ...
                <div>
                  <h4 className="text-xl font-bold text-white mb-2">Équipements certifiés</h4>
                  <p className="text-sm text-mft-grey">Équipements de référence mondiale, fiables et performants.</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            {/* Floating badge */}
            <div className="absolute -left-8 md:-left-12 bottom-12 bg-white p-6 rounded-2xl shadow-xl border border-gray-100 max-w-[200px] z-30 animate-bounce" style={{animationDuration: '3s'}}>
              <div className="font-heading font-extrabold text-4xl text-mft-dark mb-1">100%</div>
              <div className="text-sm font-bold text-mft-orange leading-tight uppercase">Solutions sur mesure</div>
            </div>
          </motion.div>
