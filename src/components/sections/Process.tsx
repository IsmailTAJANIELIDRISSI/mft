...
const Process = () => {
  const steps = [
    { num: 1, title: "Prise de contact", desc: "Définition des besoins initiaux." },
    { num: 2, title: "Étude technique", desc: "Analyse et dimensionnement précis." },
    { num: 3, title: "Installation", desc: "Pose et mise en service sur site." },
    { num: 4, title: "Suivi & Maintenance", desc: "Assistance et contrat de service." }
  ];
    ...
    <section ref={sectionRef} className="py-24 lg:py-32 bg-white overflow-hidden">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="text-center max-w-2xl mx-auto mb-20 lg:mb-28">
          <span className="text-mft-orange uppercase tracking-widest text-xs font-bold mb-4 inline-block">HOW IT WORKS</span>
          <h2 className="font-heading font-bold text-4xl lg:text-5xl text-mft-dark mb-6">Processus de réalisation</h2>
          <p className="text-mft-grey text-lg">De la conception à la maintenance, découvrez notre méthodologie d'intervention éprouvée.</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-6 relative z-10">
            {steps.map((step, i) => (
              ...
              >
                ...
                <h3 className="font-heading font-bold text-xl text-mft-dark mb-3">{step.title}</h3>
