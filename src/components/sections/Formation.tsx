...
const Formation = () => {
  ...
  return (
    <section id="formation" className="py-24 lg:py-32 bg-mft-dark relative overflow-hidden">
      {/* Background patterns */}
      <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(#E87722 1px, transparent 1px)', backgroundSize: '30px 30px' }}></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-lg text-white/70 mb-10 leading-relaxed font-light">
              Des programmes de formation sur-mesure pour exploitants, techniciens et opérateurs, dispensés par nos spécialistes expérimentés directement sur site ou dans nos salles équipées.
            </p>
            <a href="#contact" className="inline-block px-8 py-4 rounded-full bg-mft-orange/10 border border-mft-orange/30 text-mft-orange font-bold text-center transition-all hover:bg-mft-orange hover:text-white hover:border-mft-orange hover:-translate-y-1 shadow-[0_0_20px_rgba(232,119,34,0.15)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 relative">
            ...
            {formationCards.map((card, index) => (
              ...
              >
                ...
                <h3 className="font-heading font-bold text-white text-xl mb-3">{card.title}</h3>
