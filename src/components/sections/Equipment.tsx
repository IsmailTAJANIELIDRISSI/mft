    ...
    <section id="equipement" className="py-24 lg:py-32 bg-mft-bg">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-mft-orange uppercase tracking-widest text-xs font-bold mb-4 inline-block tracking-widest">
            ÉQUIPEMENTS
          </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {eqCategories.map((cat, i) => (
            ...
            >
              ...
              <h4 className="font-heading font-bold text-lg text-mft-dark">
                {cat.name}
              </h4>
            </motion.div>
          ))}
