  ...
  return (
    <section className="relative min-h-screen flex items-center pt-24 pb-32 overflow-hidden bg-mft-dark">
      ...
      <div className="absolute inset-0 z-0 bg-mft-dark">
        ...
        {/* Shimmer overlay — fades out once a background image loads */}
        {!bgLoaded && (
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 flex flex-col h-full justify-between">
        <div className="max-w-4xl mt-12 md:mt-24">
          ...
          >
            {titleWords.map((word, i) => (
              <motion.span
                key={i}
                variants={item}
                className="inline-block mr-2 lg:mr-3 mb-0"
              >
                {word}
              </motion.span>
            ))}
          ...
          >
            <a
              href="#services"
              className="px-8 py-4 rounded-full bg-mft-orange text-white font-bold text-center transition-all hover:bg-mft-orange-light hover:scale-105 active:scale-95 shadow-xl shadow-mft-orange/20 relative overflow-hidden group"
            >
            ...
            <a
              href="#contact"
              className="px-8 py-4 rounded-full border border-white/30 text-white font-bold text-center transition-all hover:bg-white/10 hover:border-white"
            >
              Nous contacter
            </a>
          </motion.div>
